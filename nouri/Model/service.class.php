...
include('../includes/connect_db.php');
		...
		$req = $bdd->exec("INSERT INTO `service`(`noms`, `desc`, `image`, `prix`,`categorie`)VALUES('$this->noms','$this->desc','$this->image'
			,'$this->prix','$this->categorie')");
...
public function modifier(){ 
    ...
    include('../includes/connect_db.php');
       ...
       $id=$_GET['id'];
        ...
        $r=$bdd->exec(" UPDATE `service` SET `noms`='$this->noms',`desc`='$this->desc',`prix`='$this->prix',`categorie`='$this->categorie' WHERE ids= $id ");
