   ...
   <?php include ('menu.php');?>
      ...
      <section>
         ...
         <section class="main-content">
            ...
            <div class="row">
               <div class="col-lg-6">
                  <form  action="controller/modifcategories.php?id=<?php echo $donnees['idc']  ?>" method="post">
                     <!-- START panel-->
                  
                        
                        <div class="panel-body">
                           <div class="form-group">
                              <label class="control-label">Nom Categories</label>
                              <input type="text" name="nomc" value="<?php echo $donnees['nomc']?>" required class="form-control">
                           </div>
