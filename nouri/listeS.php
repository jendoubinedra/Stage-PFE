            ...
            <div class="panel panel-default">
               ...
               <?php
                                      if(isset($_GET['resultat'])){
                                        if ($_GET['resultat'] ==' ajouter service'){
                                    ...
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                     ...
                                     <?php
                                      if(isset($_GET['resultat'])){
                                        if ($_GET['resultat'] =='modifier service'){
                   ...
                   <table id="data-table" class="table table-striped table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td><?php echo $donnee['noms'] ?></td>
                           <td><?php echo $donnee['desc'] ?></td>
                           <td><?php echo $donnee['image'] ?></td>
                           <td><?php echo $donnee['prix'] ?></td>
                           <td><?php echo $donnee['categorie'] ?></td>
                           
                           <td>
                              <a href="modifierservice.php?id=<?php echo $donnee['ids'] ?>" class="btn btn-primary"> Modifier</a>
                                                  
                              <a href="controller/suppservice.php?id=<?php echo $donnee['ids'] ?>" class="btn btn-danger">Supprimer</a></td>
