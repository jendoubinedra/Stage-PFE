   ...
   <?php include ('menu.php');?>
      ...
      <section>
         ...
         <section class="main-content">
            ...
            <div class="row">
               <div class="col-lg-6">
                  <form  action="controller/ajout-service.php" method="post">
                     <!-- START panel-->
                        ...
                        <div class="panel-body">
                           <div class="form-group">
                              ...
                              <input type="text" name="noms" required class="form-control" value="<?php echo $donnees['noms']?>">
                           </div>
                           <div class="form-group">
                              <label class="control-label">Description</label>
                              <input type="text" name="desc" required class="form-control" value="<?php echo $donnees['desc']?>">
                           </div>
                           <div class="form-group">
                              <label class="control-label">Image</label>
                              <input  type="file" name="image" required class="form-control" value="<?php echo $donnees['image']?>">
                           </div>
                           <div class="form-group">
                              <label class="control-label">Prix</label>
                              <input  type="text" name="prix" required class="form-control" value="<?php echo $donnees['prix']?>"> 
                           </div>
                            <div class="form-group">
                              <label class="control-label">Categorie</label>
                              <input  type="text" name="categorie" required class="form-control" value="<?php echo $donnees['categorie']?>">
                           </div>
