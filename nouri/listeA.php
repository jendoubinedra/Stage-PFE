            ...
            <div class="panel panel-default">
               ...
               <?php
                                    ...
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                     ...
                                     <?php
                                      if(isset($_GET['resultat'])){
                                        if ($_GET['resultat'] =='modifier admin'){
                   ...
                   <table id="data-table" class="table table-striped table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td><a href ="mailto:<?php echo  $donnee['email'] ?>"><?php $donnee['nom']?></a></td>
                           <td><?php echo $donnee['password'] ?></td>
                           <td>
                              <a href="modifieradmin.php?id=<?php echo $donnee['id'] ?>" class="btn btn-primary"><i class="icon icon-contacts-app icon-fw icon-lg"></i> Modifier</a>
                                                  
                              <a href="controller/suppadmin.php?id=<?php echo $donnee['id'] ?>" class="btn btn-danger">Supprimer</a></td>
