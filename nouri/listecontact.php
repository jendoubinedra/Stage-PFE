               ...
               <div class="table-responsive">
                   <table id="data-table" class="table table-striped table-bordered table-hover">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td><?php echo $donnee['nomcontact'] ?></td>
                           <td><?php echo $donnee['sujet'] ?></td>
                           <td><?php echo $donnee['message'] ?></td>
                           
                           <td>
                              
                                                  
                              <a href="controller/suppcontact.php?id=<?php echo $donnee['idcontact'] ?>" class="btn btn-danger">Supprimer</a></td>
