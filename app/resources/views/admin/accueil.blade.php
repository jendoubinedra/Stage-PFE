...
<!-- Mirrored from codeboxr.net/themedemo/unialumni/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 22:14:58 GMT -->
<head>
    <meta charset="utf-8">
...
<meta property="og:image"
      content="public/img/opengraph/fbphoto-476-476.png"/> <!-- when you post this page url in facebook , this image will be shown -->
...
<link rel="icon" type="image/x-icon" href="public/img/favicon/favicon.ico"/> <!-- this icon shows in browser toolbar -->
...
<link rel="stylesheet" href="public/vendor/navbar/bootstrap-4-navbar.css" />

<!--Animate css -->
<link rel="stylesheet" href="public/vendor/animate/animate.css" media="all" />

<!-- FONT AWESOME CSS -->
<link rel="stylesheet" href="public/vendor/fontawesome/css/font-awesome.min.css" />

<!--owl carousel css -->
<link rel="stylesheet" href="public/vendor/owl-carousel/owl.carousel.css" media="all" />

<!--Magnific Popup css -->
<link rel="stylesheet" href="public/vendor/magnific/magnific-popup.css" media="all" />

<!--Nice Select css -->
<link rel="stylesheet" href="public/vendor/nice-select/nice-select.css" media="all" />

<!--Offcanvas css -->
<link rel="stylesheet" href="public/vendor/js-offcanvas/css/js-offcanvas.css" media="all" />
                    ...
                    <div class="upcoming-event-content owl-carousel">
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="up-event-thumb">
                                        <img src="public/img/event/event-img-1.jpg" class="img-fluid" alt="Upcoming Event">
                        ...
                        <div class="single-upcoming-event">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="up-event-thumb">
                                        <img src="public/img/event/event-img-2.jpg" class="img-fluid" alt="Upcoming Event">
                                        <h4 class="up-event-date">It’s 27 February 2019</h4>
                                    </div>
                                </div>
                        ...
                        <div class="single-upcoming-event">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="up-event-thumb">
                                        <img src="public/img/event/event-img-3.jpg" class="img-fluid" alt="Upcoming Event">
                                        <h4 class="up-event-date">It’s 27 February 2019</h4>
                                    </div>
                                </div>
                ...
                <div class="col-lg-10 ml-auto">
                    <div class="about-content-wrap">
                        ...
                        <div class="about-thumb">
                            <img src="public/img/about-bg.jpg" alt="" class="img-fluid">
                        </div>

                        <p>L’association de développement de la communication (ADECO) est une association créée en avril 2015 à Siliana, dans le Nord-Ouest tunisien. L’ADECO œuvre pour le développement du tissu associatif à Siliana et pour une vie citoyenne ouverte à la culture et à la mise en valeur du patrimoine culturel et artistique local. Plus particulièrement, l’ADECO a pour objectif de promouvoir les valeurs citoyennes et le respect des droits de l’Homme dans la région par le biais d’outils de communication adaptés, et d’activités culturelles et artistiques.
  
        ...
        <div class="row text-center text-sm-left">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-responsibility">
                    <img src="public/img/responsibility/01.png" alt="Responsibility">
                    <h4>Scholarship</h4>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-responsibility">
                    <img src="public/img/responsibility/02.png" alt="Responsibility">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-responsibility">
                    <img src="public/img/responsibility/03.png" alt="Responsibility">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-responsibility">
                    <img src="public/img/responsibility/04.png" alt="Responsibility">
    ...
    <div class="container-fluid">
        <div class="row text-center">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-funfact-wrap">
                    <div class="funfact-icon">
                        <img src="public/img/fun-fact/user.svg" alt="Funfact">
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-funfact-wrap">
                    <div class="funfact-icon">
                        <img src="public/img/fun-fact/picture.svg" alt="Funfact">
                    </div>
                    <div class="funfact-info">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-funfact-wrap">
                    <div class="funfact-icon">
                        <img src="public/img/fun-fact/event.svg" alt="Funfact">
                    </div>
                    <div class="funfact-info">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-funfact-wrap">
                    <div class="funfact-icon">
                        <img src="public/img/fun-fact/medal.svg" alt="Funfact">
                    </div>
                    <div class="funfact-info">
                    ...
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            <div class="job-oppor-logo">
                                <div class="display-table">
                                    <div class="display-table-cell">
                                        <img src="public/img/job/compnay-logo-1.png" alt="Job">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            <div class="job-oppor-logo">
                                <div class="display-table">
                                    <div class="display-table-cell">
                                        <img src="public/img/job/compnay-logo-2.png" alt="Job">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            <div class="job-oppor-logo">
                                <div class="display-table">
                                    <div class="display-table-cell">
                                        <img src="public/img/job/compnay-logo-3.png" alt="Job">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            <div class="job-oppor-logo">
                                <div class="display-table">
                                    <div class="display-table-cell">
                                        <img src="public/img/job/compnay-logo-4.png" alt="Job">
                                    </div>
                                </div>
                            </div>
    ...
    <div class="col-lg-3  col-sm-6 recent event">
        <div class="single-gallery-item gallery-bg-1">
            <div class="gallery-hvr-wrap">
                ...
                <a href="public/img/gallery/gellary-img-1.jpg" class="btn-zoom image-popup">
                    <img src="public/img/zoom-icon.png" alt="a">
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3  col-sm-6 recent pic">
        <div class="single-gallery-item gallery-bg-3">
            <div class="gallery-hvr-wrap">
                ...
                <a href="public/img/gallery/gellary-img-3.jpg" class="btn-zoom image-popup">
                    <img src="public/img/zoom-icon.png" alt="a">
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-3  col-sm-6 old">
        <div class="single-gallery-item gallery-bg-4">
            <div class="gallery-hvr-wrap">
                ...
                <a href="public/img/gallery/gellary-img-4.jpg" class="btn-zoom image-popup">
                    <img src="public/img/zoom-icon.png" alt="a">
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-3  col-sm-6 pic event">
        <div class="single-gallery-item gallery-bg-5">
            <div class="gallery-hvr-wrap">
                ...
                <a href="public/img/gallery/gellary-img-5.jpg" class="btn-zoom image-popup">
                    <img src="public/img/zoom-icon.png" alt="a">
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-3  col-sm-6 old recent">
        <div class="single-gallery-item gallery-bg-6">
            <div class="gallery-hvr-wrap">
                ...
                <a href="public/img/gallery/gellary-img-6.jpg" class="btn-zoom image-popup">
                    <img src="public/img/zoom-icon.png" alt="a">
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-3  col-sm-6 pic recent old">
        <div class="single-gallery-item gallery-bg-8">
            <div class="gallery-hvr-wrap">
                ...
                <a href="public/img/gallery/gellary-img-8.jpg" class="btn-zoom image-popup">
                    <img src="public/img/zoom-icon.png" alt="a">
                </a>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <article class="single-blog-post">
                    <figure class="blog-thumb">
                        <div class="blog-thumbnail">
                            <img src="public/img/blog/blog-1.jpg" alt="Blog" class="img-fluid" />
                        </div>
                        <figcaption class="blog-meta clearfix">
                            <a href="single-blog.html" class="author">
                                <div class="author-pic">
                                    <img src="public/img/blog/author.jpg" alt="Author">
                                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <article class="single-blog-post">
                    <figure class="blog-thumb">
                        <div class="blog-thumbnail">
                            <img src="public/img/blog/blog-2.jpg" alt="Blog" class="img-fluid" />
                        </div>
                        <figcaption class="blog-meta clearfix">
                            <a href="single-blog.html" class="author">
                                <div class="author-pic">
            ...
            <div class="col-lg-4 col-md-6">
                <article class="single-blog-post">
                    <figure class="blog-thumb">
                        <div class="blog-thumbnail">
                            <img src="public/img/blog/blog-3.jpg" alt="Blog" class="img-fluid" />
                        </div>
                        <figcaption class="blog-meta clearfix">
                            <a href="single-blog.html" class="author">
                                <div class="author-pic">
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                <img src="public/img/footer-logo.png" alt="Logo" class="img-fluid" />
...
<script src="public/vendor/navbar/bootstrap-4-navbar.js"></script>

<!--owl-->
<script src="public/vendor/owl-carousel/owl.carousel.min.js"></script>

<!--Waypoint-->
<script src="public/vendor/waypoint/waypoints.min.js"></script>
...
<!--magnific-->
<script src="public/vendor/magnific/jquery.magnific-popup.min.js"></script>

<!--Smooth Scroll-->
<script src="public/vendor/smooth-scroll/jquery.smooth-scroll.min.js"></script>

<!--Jquery Easing-->
<script src="public/vendor/jquery-easing/jquery.easing.1.3.min.js"></script>

<!--Nice Select -->
<script src="public/vendor/nice-select/jquery.nice-select.js"></script>

<!--Jquery Valadation -->
<script src="public/vendor/validation/jquery.validate.min.js"></script>
<script src="public/vendor/validation/additional-methods.min.js"></script>

<!--off-canvas js -->
<script src="public/vendor/js-offcanvas/js/js-offcanvas.pkgd.min.js"></script>

<!-- Countdown -->
<script src="public/vendor/jquery.countdown/jquery.countdown.min.js"></script>
...
<script id="switcherhandle" src="public/switcher/switcher.js"></script>
