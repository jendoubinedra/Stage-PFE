    ...
    <div class="dt-brand">
      ...
      <span class="dt-brand__logo">
        <a class="dt-brand__logo-link" href="index-2.html">
          <img class="dt-brand__logo-img d-none d-sm-inline-block" src="assets/imag/imagee.png" alt="">
          <img class="dt-brand__logo-symbol d-sm-none" src="assets/imag/imagee.png" alt="">
        </a>
      </span>
      <!-- /brand logo -->
