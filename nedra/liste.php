          ...
          <div class="row align-items-center d-flex justify-content-between">
            ...
            <div class="col-lg-10">
              <div class="d-flex align-items-center">
                ...
                <div>
                  <i class="fa-solid fa-file-lock"></i></div>
                <!-- <div class="header-search-btn">
                  <div class="search-btn">
                    <i class="flaticon-magnifiying-glass"></i>
                  </div>
                </div> -->
                <!-- <i class="fa-solid fa-file-lock"></i><div><?php echo $_SESSION['nomclient']?>
                  <a href="includes/deconnexion2.php" type="button" class="btn btn-dark">Logout</a> -->
               <span>
    ...
    <div class="page-inner ptb-120">
      <div class="">
        <div class="">
          ...
          <div>
          <a href="ajouter-devis.php"><button type="button" class="btn btn-primary">ajouter</a> </button>
            <div class="container">
              <div id="message"></div>
