...
<!-- Mirrored from codeboxr.net/themedemo/unialumni/html/directory.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Mar 2022 22:15:31 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="typography.pho">Typography</a></li>
                                    </ul>
                                </li>
                        ...
                        <div class="directory-text-wrap">
                            ...
                            <div class="directory-table table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="assets/img/testimonial/testi-1.png" alt="table">Angelina Jolie Voight</td>
                                            <td>Computer</td>
                                            <td>2014</td>
                                            <td>Dhaka</td>
                                            <td>Student</td>
                                        ...
                                        <tr>
                                            <td><img src="assets/img/testimonial/testi-2.png" alt="table">Angelina Jolie Voight</td>
                                            <td>Computer</td>
                                            <td>2014</td>
                                            <td>Dhaka</td>
                                            <td>Student</td>
                                        ...
                                        <tr>
                                            <td><img src="assets/img/testimonial/testi-3.png" alt="table">Angelina Jolie Voight</td>
                                            <td>Computer</td>
                                            <td>2014</td>
                                            <td>Dhaka</td>
                                            <td>Student</td>
